...
| `packages/pier-hooks/src/engine/Profiler.cpp` | `same path` | ✔ done, rewritten: five inclusive timing buckets, High priority wrapping TickControl on the outside, and the comment on sample meaning under warp kept |
